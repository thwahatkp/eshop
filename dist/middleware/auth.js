    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                response = (0, token_1.verifyToken)(token);
                if (response === "TokenExpiredError") {
                    return [2 /*return*/, res.status(401).json({ staus: false, message: "token expired" })];
                }
                ...
                return [4 /*yield*/, model_1.Users.findById(response._id).select("-password -__v -createdAt -updatedAt")];
            case 1:
                user = _a.sent();
                req.user = user;
                next();
            ...
            case 4:
                error_1 = _a.sent();
                res.status(400).json({ status: false, message: error_1.message });
                return [3 /*break*/, 5];
