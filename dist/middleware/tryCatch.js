...
var tryCatch = function (errFunction) { return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, errFunction(req, res, next)];
            case 1:
                result = _a.sent();
...
var ResponseHandler = function (res, result) {
    var response = {
