...
router.post("/logout", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
            ...
            return [2 /*return*/, next(new AppError_1.default(400, error.message))];
        }
        return [2 /*return*/];
    });
}); });
...
router.get("/auth/google/callback", passport_1.default.authenticate("google", {
    failureRedirect: "".concat(process.env.CLIENT_URL, "logint"),
    successRedirect: "".concat(process.env.CLIENT_URL),
}));
