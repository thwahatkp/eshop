...
exports.registerUser = (0, tryCatch_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let mobileExist = yield model_1.default.Users.findOne({ mobile: mobile });
    let emailExist = yield model_1.default.Users.findOne({ email: email });
    let usernameExist = yield model_1.default.Users.findOne({ username: username });
    if (usernameExist) {
    ...
    let response = new model_1.default.Users({
        fname: firstname,
        lname: lastname,
        mobile: mobile,
        username: username,
    ...
    return new AppResponse_1.default("sucesss", { data: response }, CREATED);
}));
