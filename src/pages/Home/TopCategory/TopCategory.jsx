        ...
        <div className="container max-w-[90%] m-auto">
          <div className="heading d_flex flex justify-between">
            <div
              ...
              <i className="fa-solid fa-border-all text-xl md:text-[30px] text-secondary m-2.5 font-black"></i>
              <h2 className="text-sm  md:text-[1.5em]  m-1.5 font-semibold">Top Categories</h2>
            </div>
