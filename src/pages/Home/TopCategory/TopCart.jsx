...
const TopCart = () => {
  ...
  return (
    <div className="overflow-hidden">
      <Slider {...settings}>
        <div className="box product bg-white p-5 relative rounded-md shadow flex flex-col items-center justify-center transition ease-in-out duration-500 hover:scale-105 cursor-pointer">
          ...
          <div className="img grow relative rounded-lg">
            <Skeleton variant="rectangular" width="100%" height={89} style={{ marginBottom: "10px", borderRadius: "8px" }} />
          </div>
        </div>
        {Tdata.map((value, index) => {
          return (
            <div
              key={index}
              className="box product bg-white p-5 relative rounded-md shadow flex flex-col items-center justify-center transition ease-in-out duration-500 hover:scale-105 cursor-pointer">
