...
const Login = () => {
  ...
  return (
    <div className="flex items-center min-h-[80vh] p-4 my-auto bg-gray-100 lg:justify-center">
      <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-lg">
        <div className="p-4 py-6 text-white bg-purple-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
          <div className="my-3 text-4xl font-extrabold  text-center">
            <Link to="#">eshop</Link>
          </div>
          <p className="mt-6 font-normal text-center text-gray-300 md:mt-0">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ratione
            neque sunt nostrum aliquid ut eligendi placeat rem repudiandae
        ...
        <div className="p-5 bg-white md:flex-1">
          ...
          >
            ...
            <div className="flex flex-col space-y-1 ">
              ...
              {
                error && <span className="text-center font-medium text-red-500 text-sm">
                  {error}
                </span>
              }
            </div>
