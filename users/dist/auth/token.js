...
const generateToken = (user) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const accessToken = jsonwebtoken_2.default.sign(payload, config_1.ACCESS_TOKEN_SECRET, { expiresIn: "15m" });
        const refreshToken = jsonwebtoken_2.default.sign(payload, config_1.REFRESH_TOKEN_SECRET, { expiresIn: "30d" });
...
const verifyRefreshToken = (refreshToken) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, jsonwebtoken_1.verify)(refreshToken, config_1.REFRESH_TOKEN_SECRET, (err, tokenDetails) => {
            if (err)
                return reject({ success: false, message: "Invalid refresh token" });
            resolve({
                tokenDetails,
